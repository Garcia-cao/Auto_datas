    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var GridManager = function () {
            ...
            _createClass(GridManager, [{
                ...
                key: 'setUrlData',
                value: function setUrlData(table, query, url, type, isGotoFirstPage, callback) {
                    ...
                    _Base.jTool.extend(settings, {query: query});
                    _Base.jTool.extend(settings, {ajax_url: url});
                    _Base.jTool.extend(settings, {ajax_type: type});
                    if (isGotoFirstPage) {
                        settings.pageData.cPage = 1;
                    }
                    _Cache2.default.setSettings($table, settings);
...
// 公开方法列表
        var GM_PUBLISH_METHOD_LIST = exports.GM_PUBLISH_METHOD_LIST = ['init', 'get', 'version', 'getLocalStorage', 'clear', 'getRowData', 'setSort', 'showTh', 'hideTh', 'exportGridToXls', 'setQuery', 'setUrlData', 'setAjaxData', 'refreshGrid', 'getCheckedTr', 'getCheckedData'];
   ...
   * */
                ...
                key: 'setUrlData',
                value: function setUrlData(table, query, url, type, isGotoFirstPage, callback) {
                    _GridManager2.default.setUrlData(table, query, url, type, isGotoFirstPage, callback);
                }
...
// removed by extract-text-webpack-plugin
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        !function t(e, n, o) {
            ...
            1: [function (t, e, n) {
                var o = t("./utilities"), i = t("../src/Css"), r = {
                    show: function () {
                        ...
                        var r = this, s = "", a = "", u = r.DOMList[0];
                        if (t) {
                            "undefined" === o.type(n) && "function" === o.type(e) && (n = e, e = 0), "undefined" === o.type(n) && (n = o.noop), "undefined" === o.type(e) && (e = 0), o.each(t, function (t, e) {
                                t = o.toHyphen(t), s += t + ":" + o.getStyle(u, t) + ";", a += t + ":" + e + ";"
                            });
                            var c = "@keyframes jToolAnimate {from {" + s + "}to {" + a + "}}",
                                l = document.createElement("style");
                            l.className = "jTool-animate-style", l.type = "text/css", document.head.appendChild(l), l.textContent = l.textContent + c, u.style.animation = "jToolAnimate " + e / 1e3 + "s ease-in-out forwards", window.setTimeout(function () {
                                i.css.call(r, t), u.style.animation = "", l.remove(), n()
                            }, e)
                        }
                    }
                };
                ...
                var o = t("./utilities"), i = {
                    addClass: function (t) {
                        ...
                        return o.each(this.DOMList, function (t, i) {
                ...
                var o = t("./utilities"), i = {
                    css: function (t, e) {
                        function n(t, e) {
                            "number" === o.type(e) && (e = e.toString()), -1 !== r.indexOf(t) && -1 === e.indexOf("px") && (e += "px"), o.each(i.DOMList, function (n, o) {
                                o.style[t] = e
                            })
                        }
                    ...
                    dataKey: "jTool" + o.version, data: function (t, e) {
                        ...
                        if (void 0 !== e) {
                            ...
                            return "string" !== r && "number" !== r || n.attr(t, e), o.each(n.DOMList, function (o, r) {
                                i = r[n.dataKey] || {}, i[t] = e, r[n.dataKey] = i
                            }), this
                        }
                        return i = n.DOMList[0][n.dataKey] || {}, this.transformValue(i[t] || n.attr(t))
                    }, removeData: function (t) {
                        var e, n = this;
                        void 0 !== t && (o.each(n.DOMList, function (o, i) {
                            e = i[n.dataKey] || {}, delete e[t]
                        }), n.removeAttr(t))
                    }, attr: function (t, e) {
                ...
                var o = t("./utilities"), i = t("./Sizzle"), r = {
                    append: function (t) {
                        ...
                        var n = this, i = o.type(t);
                        t.jTool ? t = t.DOMList : "string" === i ? t = o.createDOM(t || "") : "element" === i && (t = [t]);
                        var r;
                        return o.each(n.DOMList, function (n, i) {
                            e ? "prepend" === e && (r = i.firstChild) : i.innerHTML = "", o.each(t, function (t, e) {
                        ...
                        return o.each(this.DOMList, function (n, o) {
                            e = o.parentNode;
                            var r = new i(t, o.ownerDocument).get(0);
                        ...
                        if (void 0 === t) return new i(n);
                        var o = document.querySelectorAll(t);
                        return e(), new i(n)
                    }, parent: function () {
                        return this.closest()
                    }, clone: function (t) {
                        return new i(this.DOMList[0].cloneNode(t || !1))
                    }, remove: function () {
                ...
                var o = t("./utilities"), i = {
                    on: function (t, e, n, o) {
                    ...
                    }, getEventObject: function (t, e, n, i) {
                        if ("function" == typeof e && (i = n || !1, n = e, e = void 0), !t) return o.error("事件绑定失败,原因: 参数中缺失事件类型"), this;
                        ...
                        return o.each(t, function (t, i) {
                            o.each(n.DOMList, function (t, n) {
                                n.jToolEvent && (e = n.jToolEvent[i.eventName]) && (o.each(e, function (t, e) {
                                    n.removeEventListener(e.type, e.callback)
                                }), n.jToolEvent[i.eventName] = void 0)
                            })
                        }), n
                    }
                };
                ...
                var o = t("./utilities"), i = function (t, e) {
                    var n;
                    return t ? o.isWindow(t) ? (n = [t], e = void 0) : t === document ? (n = [document], e = void 0) : t instanceof HTMLElement ? (n = [t], e = void 0) : t instanceof NodeList || t instanceof Array ? (n = t, e = void 0) : t.jTool ? (n = t.DOMList, e = void 0) : /<.+>/.test(t) ? (n = o.createDOM(t), e = void 0) : (e ? e = "string" == typeof e ? document.querySelectorAll(e) : e instanceof HTMLElement ? [e] : e instanceof NodeList ? e : e.jTool ? e.DOMList : void 0 : n = document.querySelectorAll(t), e && (n = [], o.each(e, function (e, i) {
                        o.each(i.querySelectorAll(t), function (t, e) {
                            e && n.push(e)
                        })
                ...
                function o(t) {
                    ...
                    if (t = s(e, t), !t.url) return void a.error("jTool ajax: url不能为空");
                    var n = new XMLHttpRequest, o = "";
                    "object" === a.type(t.data) ? a.each(t.data, function (t, e) {
                        "" !== o && (o += "&"), o += t + "=" + e
                    }) : o = t.data, "GET" === t.type.toUpperCase() && o && (t.url = t.url + (-1 === t.url.indexOf("?") ? "?" : "&") + o, o = null), n.open(t.type, t.url, t.async);
                    for (var i in t.xhrFields) n[i] = t.xhrFields[i];
                    for (var r in t.headers) n.setRequestHeader(r, t.headers[r]);
                    t.beforeSend(n), n.onload = function () {
                        t.complete(n, n.status)
                    }, n.onreadystatechange = function () {
                        4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.success(n.response, n.status) : t.error(n, n.status, n.statusText))
                    }, n.send(o)
                }
                ...
                var s = t("./extend"), a = t("./utilities");
                e.exports = {ajax: o, post: i, get: r}
            }, {"./extend": 11, "./utilities": 13}], 11: [function (t, e, n) {
                function o() {
                    function t(e, o) {
                        for (var r in e) e.hasOwnProperty(r) && (n && "object" === i.type(e[r]) ? ("object" !== i.type(o[r]) && (o[r] = {}), t(e[r], o[r])) : o[r] = e[r])
                    }
                ...
                var o = t("./Sizzle"), i = t("./extend"), r = t("./utilities"), s = t("./ajax"), a = t("./Event"),
                    u = t("./Css"), c = t("./Class"), l = t("./Document"), d = t("./Offset"), f = t("./Element"),
                    h = t("./Animate"), p = t("./Data"), v = function (t, e) {
                        return new o(t, e)
                    };
                o.prototype = v.prototype = {}, v.extend = v.prototype.extend = i, v.extend(r), v.extend(s), v.prototype.extend(a), v.prototype.extend(u), v.prototype.extend(c), v.prototype.extend(l), v.prototype.extend(d), v.prototype.extend(f), v.prototype.extend(h), v.prototype.extend(p), void 0 !== window.$ && (window._$ = $), window.jTool = window.$ = v, e.exports = v
            }, {
                "./Animate": 1,
                "./Class": 2,
                "./Css": 3,
                ...
                function s(t) {
                    return g[y.call(t)] || (t instanceof Element ? "element" : "")
                }
                ...
                var y = Object.prototype.toString, g = {
